...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_tkl_f13_ansi(
        KC_ESC,     KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,   KC_F7,   KC_F8,    KC_F9,   KC_F10,     KC_F11,     KC_F12,      KC_F13,    KC_SCRL,   KC_PSCR,   KC_PAUSE,
        ...
        KC_LCTL,    KC_LALT,  KC_LGUI,                   KC_SPACE,                                      KC_RGUI,    KC_RALT,    KC_MENU,     KC_RCTL,   KC_RIGHT,  KC_DOWN,   KC_LEFT
    )
};